...
I implemented a series of progressively complex time series models to determine the best fit for the data:
...
While the ARIMA framework provides a solid baseline for trend analysis, the high volatility of Bitcoin suggests that historical price data alone is insufficient for high-precision forecasting. I recommend that stakeholders use these models as a directional indicator of market momentum rather than a definitive predictor of specific price points.
